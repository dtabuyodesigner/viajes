...
/tests/               164 comprobaciones + fotografías de comportamiento
```
...
node tests/probar.js   # las 164 en verde
...
**`node tests/probar.js`** — 164 comprobaciones: que cada app carga y pinta, que
